		...
		<div class="row">
			<div class="col-md-12">
				<div class="text-center">
				 <h1 class="heading wow fadeInUp" data-wow-duration="2s"><?php echo $home_latest_post_option['blog_heading_title'];?></h1>
				  <div class="pagetitle-separator wow fadeInUp" data-wow-duration="2s"></div>
				</div>
			</div>
		</div>
		<!-- /Section Title -->		
...
<!-- Item Scroll -->
	 <div class="carousel slide" data-ride="carousel" data-type="multi" data-interval="3000" id="home-blog">
	  <div class="row">
		...
		<div class="carousel-inner wow fadeInUp" data-wow-duration="2s">
