 ...
 <div class="main-slider">		
	<div id="home-slider" class="carousel slide " data-ride="carousel" <?php if($slider_setting['slider_transition_delay'] != '') { ?> data-interval="<?php echo $slider_setting['slider_transition_delay']; } ?>">
		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="item">
			<?php if($slider_setting['slider_two_image'] !='') { ?>
			<img src="<?php echo esc_url($slider_setting['slider_two_image']); ?>" class="img-responsive" alt="<?php echo esc_attr($slider_setting['slider_image_title_two']); ?>">
			<?php } ?>
                  <div class="carousel-caption">
