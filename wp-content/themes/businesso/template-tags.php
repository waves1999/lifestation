...
function businesso_archive_title( $before = '<h1 class="pagetitle white wow fadeInLeft" data-wow-duration="2s">', $after = '</h1>' ) {
	if( is_archive() )
	{
	...
	<div class="container">
		...
		<div class="footer-bottom">
		  <div class="container">
			<div class="row">
				<div class="col-md-12">
            <p class="copyright wow fadeInUp" data-wow-duration="2s"><?php if($footer_setting['footer_customization_text'] !='') { echo esc_attr($footer_setting['footer_customization_text']); }?>
            <a href="<?php echo esc_url($footer_setting['footer_customization_frim_url']); ?>" <?php if($footer_setting['footer_link_new_tab'] ==1) { ?> target=" _blank" <?php }else{ ?> target="_self" <?php } ?> > <?php if($footer_setting['footer_customization_frim_name'] !='') { echo esc_attr($footer_setting['footer_customization_frim_name']); }?> </a>
            </p>
