...
//define
define('VW_EVENT_PLANNER_FREE_THEME_DOC','https://www.vwthemesdemo.com/docs/free-vw-event-planner/','vw-event-planner');
define('VW_EVENT_PLANNER_SUPPORT','https://wordpress.org/support/theme/vw-event-planner/','vw-event-planner');
define('VW_EVENT_PLANNER_REVIEW','https://wordpress.org/support/theme/vw-event-planner/reviews/','vw-event-planner');
define('VW_EVENT_PLANNER_BUY_NOW','https://www.vwthemes.com/themes/event-wordpress-theme/','vw-event-planner');
define('VW_EVENT_PLANNER_LIVE_DEMO','https://www.vwthemes.net/vw-event-planner-pro/','vw-event-planner');
define('VW_EVENT_PLANNER_PRO_DOC','https://www.vwthemesdemo.com/docs/vw-event-planner-pro/','vw-event-planner');
define('VW_EVENT_PLANNER_FAQ','https://www.vwthemes.com/faqs/','vw-event-planner');
define('VW_EVENT_PLANNER_CHILD_THEME','https://developer.wordpress.org/themes/advanced-topics/child-themes/','vw-event-planner');
define('VW_EVENT_PLANNER_CONTACT','https://wordpress.org/support/theme/vw-event-planner/','vw-event-planner');
